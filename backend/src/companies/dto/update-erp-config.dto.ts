...
export class UpdateErpConfigDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() transportadoraPadrao?:
    | string
    | null;
  @ApiPropertyOptional() @IsOptional() @IsString() smtpHost?: string | null;
  @ApiPropertyOptional() @IsOptional() @IsInt() @Min(1) smtpPort?:
    | number
    | null;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() emailSubjectTemplate?:
    | string
    | null;
  @ApiPropertyOptional() @IsOptional() @IsString() emailBodyTemplate?:
    | string
    | null;
  ...
  @ApiPropertyOptional({
    description: 'ID do time autorizado a reagendar entregas de pedidos PA.',
  })
  @IsOptional()
  @IsString()
