...
UNION ALL
SELECT 'HRG3', RTRIM(f.COD_FILIAL), RTRIM(f.FILIAL), RTRIM(c.RAZAO_SOCIAL),
...
UNION ALL
SELECT 'HRG3', RTRIM(CENTRO_CUSTO), RTRIM(DESC_CENTRO_CUSTO), INATIVA
...
UNION ALL
SELECT 'HRG3', RTRIM(c.COD_CLIFOR), RTRIM(c.NOME_CLIFOR), RTRIM(c.RAZAO_SOCIAL),
...
UNION ALL
SELECT 'HRG3', RTRIM(CONTA_CONTABIL), RTRIM(DESC_CONTA), RTRIM(TIPO_CONTA),
...
UNION ALL
SELECT 'HRG3', RTRIM(CONDICAO_PGTO), RTRIM(DESC_COND_PGTO),
...
UNION ALL
SELECT 'HRG3', RTRIM(sf.CLIFOR), RTRIM(i.CODIGO_ITEM), RTRIM(i.ITEM_DESCRICAO),
...
UNION ALL
SELECT 'HRG3', RTRIM(CODIGO_ITEM), RTRIM(ITEM_DESCRICAO), RTRIM(UNIDADE),
...
UNION ALL
SELECT 'HRG3', RTRIM(r.RATEIO_FILIAL), RTRIM(r.DESC_RATEIO_FILIAL), r.INATIVO,
...
WHERE r.INATIVO = 0 AND r.RATEIO_ENTRAR_EM_LISTA <> 0
UNION ALL
SELECT 'HRG3', RTRIM(r.RATEIO_CENTRO_CUSTO), RTRIM(r.DESC_RATEIO_CENTRO_CUSTO), r.INATIVO,
...
UNION ALL
SELECT 'HRG3', RTRIM(TIPO_COMPRA), RTRIM(AE_DOCUMENTO)
...
UNION ALL
SELECT 'HRG3', CTB_TIPO_OPERACAO, RTRIM(DESC_TIPO_OPERACAO)
...
UNION ALL
SELECT 'HRG3', RTRIM(NATUREZA), RTRIM(DESC_NATUREZA), CTB_TIPO_OPERACAO
...
UNION ALL
SELECT 'HRG3', RTRIM(grade), posicao, RTRIM(tamanho)
...
-- Unimos GUESS+HRG3 e deduplicamos (são as mesmas chaves nos dois).
...
FROM GUESS_PRODUCAO.dbo.TRANSPORTADORAS
WHERE ISNULL(INATIVO, 0) = 0
UNION ALL
SELECT 'HRG3', RTRIM(TRANSPORTADORA)
